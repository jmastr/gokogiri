...
import (
	"github.com/jmastr/gokogiri/html"
	"github.com/jmastr/gokogiri/xml"
)
...
found in the github.com/jmastr/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
